...
The goal of regexciterr is to make regular expressions more exciting!
...
You can install the development version of regexciterr from [GitHub](https://github.com/) with:
